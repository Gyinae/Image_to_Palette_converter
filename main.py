...
# defining parent functions for color palettes
...
# fetch image function captures the image from the url and stores in  a local directory
def fetch_image(image_path):
  urllib.request.urlretrieve(image_path, "image")
  img = PIL.Image.open("image")
  return img

# extract color extracts the colors that appears most in the image and stores it in a color tuple
...
# render color takes the extracted colors and generate a grid of colors to be plotted
...
# It uses the matplotlib function to create a new image with the generated palette
...
image_url = input("Input your image url: ")
print(image_url)
study_image(str(image_url))